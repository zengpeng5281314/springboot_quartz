 ...
 */
@Configuration
@EntityScan(basePackages = "com.channel.zengpeng.secondary.entity")
//1、实体扫描
//2、实体管理ref
//3、事务管理
@EnableJpaRepositories(
        basePackages = "com.channel.zengpeng.secondary.dao",
...
public class JpaSecondConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        return factoryBuilder.dataSource(dataSource)
                .packages("com.channel.zengpeng.secondary.entity")
